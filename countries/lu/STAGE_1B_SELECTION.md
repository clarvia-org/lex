...
**Status:** awaiting maintainer approval before adapter expansion or data merge  
...
| Notes | Journal memorial HTML (richtext `art_N` path). XML also exists; approval authorizes HTML retention for Stage 1B HTML coverage. No HTML-only current consolidation found in sampling. |
